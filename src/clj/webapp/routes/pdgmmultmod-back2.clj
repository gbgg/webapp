...
(defn handle-pdgmmultmoddisplay
  ...
  (let [;; note problem with using atom for addpnum: gives LazySequence
        ...
        newpdgmstring1 (apply pr-str newpdgmvec)
        ;;newpdgmstring2 (clojure.string/replace newpdgmstring1 #" " "\r\n")
        newpdgmstring2 (clojure.string/replace newpdgmstring1 #"[\(\)\"]" "")
        newpdgmstring3 (apply str newpdgmstring2)
